    ...
    <nav class="navbar">
        <div class="navbar-container">
            ...
            <div class="navbar-right">
                <ul>
                    <li>
                        <a class="btn btn-navbar" href="../src/Views/initiatives_view.php">
